 ...
 *   },
 *   links = {
 *     "add-form" = "/admin/structure/locationentity/add/{locationentity_type}",
 *     "add-page" = "/admin/structure/locationentity/add",
 *     "canonical" = "/admin/structure/locationentity/{locationentity}",
 *     "collection" = "/admin/structure/locationentity",
 *     "delete-form" = "/admin/structure/locationentity/{locationentity}/delete",
 *     "edit-form" = "/admin/structure/locationentity/{locationentity}/edit",
 *   },
